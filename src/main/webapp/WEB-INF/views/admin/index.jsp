								...
								<div class="card-body">
									...
									<div class="direct-chat-messages">
										...
										<div class="direct-chat-msg">
											...
											<img class="direct-chat-img"
												src="/static/admin/dist/img/user1-128x128.jpg"
										...
										<div class="direct-chat-msg right">
											...
											<!-- /.direct-chat-infos -->
											<img class="direct-chat-img"
												src="/static/admin/dist/img/user3-128x128.jpg"
												alt="message user image">
											<!-- /.direct-chat-img -->
									...
									<div class="direct-chat-contacts">
										<ul class="contacts-list">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img"
													src="/static/admin/dist/img/user7-128x128.jpg"
													alt="User Avatar">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img"
													src="/static/admin/dist/img/user5-128x128.jpg"
													alt="User Avatar">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img"
													src="/static/admin/dist/img/user6-128x128.jpg"
													alt="User Avatar">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img"
													src="/static/admin/dist/img/user8-128x128.jpg"
													alt="User Avatar">
